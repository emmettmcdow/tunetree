...
const AiPrompt = ({}: AiPromptProps) => {
  ...
  return (
    <div className="z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fg-color rounded-2xl p-5 text-center z-50 drop-shadow-lg w-1/4">
      ...
      <form onSubmit={handleSubmit} className="flex-col items-center p-2 border-t-2 border-neutral-900  text-left">
        ...
        <div className="flex justify-center">
          <UIButton type="deny" content="Cancel" handle={() => {console.log("Cancelled")}} submit={false}/>
